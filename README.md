...
Built with Next.js, Horizon is a financial SaaS platform that connects to multiple bank accounts, displays transactions in real-time, allows users to transfer money to other platform users, and manages their finances. 
...
👉 **Funds Transfer**: Users can transfer funds using Dwolla to other accounts with the required fields and recipient bank ID.
